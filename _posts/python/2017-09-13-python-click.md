...
date: 2017-09-13
author: 大头
desc: "是用Python写的一个第三方模块，用于快速创建命令行..."
categories: ["Python"]
tags: ["python"]
permalink: "/language/python-click.html"
---
...
if __name__ == '__main__':
    try:
        ...
        # python3 test.py whois 20 superpika --p=/
        # python3 test.py whois 20 superpika --p=/ --env=1,2,3 --env=4 -e=5 -e 3
        # age:20 name:superpika,p:/,env:('1,2,3', '4', '=5', '3')
