...
date: 2016-03-01
author: 大头
desc: "我每天使用 Git ，但是很多命令记不住。"
categories: ["常用工具"]
tags: ["git"]
permalink: "/tool/git.html"
---
...
4. 大分支命名: release-1.0 前面表示新版本号, 后面表示新特征号
5. Release Tag命名: v1.0.0 前面表示新版本号, 后面表示新特征号,最后面表示bug修复号
...
git push origin branch --delete rm 删除远程分支
