...
date: 2017-06-01
author: 大头
desc: "RabbitMQ安装|使用|概念|Golang开发..."
categories: ["数据库"]
tags: ["database","golang"]
permalink: "/database/rabbitmq.html"
---
...
![](https://hunterhug.github.io/blog/picture/mq/ui.png)
...
![](https://hunterhug.github.io/blog/picture/mq/queue.png)

RabbitMQ中的消息都只能存储在Queue中，生产者（下图中的P）生产消息并最终投递到Queue中，消费者（下图中的C）可以从Queue中获取消息并消费。

![](https://hunterhug.github.io/blog/picture/mq/qq.png)

多个消费者可以订阅同一个Queue，这时Queue中的消息会被平均分摊给多个消费者进行处理，而不是每个消费者都收到所有的消息并处理。

![](https://hunterhug.github.io/blog/picture/mq/qq2.png)
...
![](https://hunterhug.github.io/blog/picture/mq/qq3.png)

## 4.Exchange

在上一节我们看到生产者将消息投递到Queue中，实际上这在RabbitMQ中这种事情永远都不会发生。实际的情况是，生产者将消息发送到Exchange（交换器，下图中的X），由Exchange将消息路由到一个或多个Queue中（或者丢弃）。

![](https://hunterhug.github.io/blog/picture/mq/ex.png)
...
![](https://hunterhug.github.io/blog/picture/mq/binding.png)
...
![](https://hunterhug.github.io/blog/picture/mq/fa.png)
...
![](https://hunterhug.github.io/blog/picture/mq/dir.png)
...
![](https://hunterhug.github.io/blog/picture/mq/topic.png)
...
![](https://hunterhug.github.io/blog/picture/mq/rpc.png)
